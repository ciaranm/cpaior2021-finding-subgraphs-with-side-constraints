...
plot \
    "<head -n1 nodes.data ; sed -e 1d nodes.data | shuf" u (sx("hybrid-never",1)):(sx("hybrid-always",1)):(column("family")==14?10:column("family")) w p pt var lc var, \
    x w l notitle ls 0
