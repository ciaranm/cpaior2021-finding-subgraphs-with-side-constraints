...
plot \
    "../paper/runtimes.data" u (cx("si-parity-gss-20201208",1000)):(cy("si-parity-gss-20201208",1000)) smooth cum w l ls 1 ti '\raisebox{1mm}{Glasgow+}' at end, \
    "../paper/runtimes.data" u (cx("si-parity-minion-preprocess-gac-20201208",1000)):(cy("si-parity-minion-preprocess-gac-20201208",1000)) smooth cum w l ls 3 ti '\raisebox{0.5mm}{Essence}' at end, \
    "../paper/runtimes.data" u (cx("si-parity-hybrid-preprocess-gac-comm-checker-20201208",1000)):(cy("si-parity-hybrid-preprocess-gac-comm-checker-20201208",1000)) smooth cum w l ls 5 ti '\raisebox{-1mm}{Checking}' at end, \
    "../paper/runtimes.data" u (cx("si-parity-hybrid-preprocess-gac-comm-propagate-20201208",1000)):(cy("si-parity-hybrid-preprocess-gac-comm-propagate-20201208",1000)) smooth cum w l ls 6 ti 'Propagating' at end, \
    "../paper/runtimes.data" u (cx("si-parity-hybrid-preprocess-gac-comm-rollback-20201208",1000)):(cy("si-parity-hybrid-preprocess-gac-comm-rollback-20201208",1000)) smooth cum w l ls 8 ti '\raisebox{-1mm}{Rollback}' at end, \
