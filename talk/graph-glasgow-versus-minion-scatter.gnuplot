...
plot \
    "<head -n1 ../paper/runtimes.data ; sed -e 1d ../paper/runtimes.data | shuf" u (sx("si-noninduced-minion-preprocess-gac-20201208",1000)):(sx("si-noninduced-gss-20201208",1000)) w p ls 2 ps 0.3, \
    x  w l notitle ls 0
