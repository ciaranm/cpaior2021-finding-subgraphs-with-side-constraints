...
plot \
    "../paper/runtimes.data" u (cx("si-noninduced-gss-20201208",1000)):(cy("si-noninduced-gss-20201208",1000)) smooth cum w l ls 1 ti '\raisebox{3.5mm}{Glasgow}' at end, \
    ...
    "../paper/runtimes.data" u (cx("si-noninduced-hybrid-preprocess-gac-comm-checker-20201208",1000)):(cy("si-noninduced-hybrid-preprocess-gac-comm-checker-20201208",1000)) smooth cum w l ls 5 ti '\raisebox{0.7mm}{Checking \&}' at end, \
    "../paper/runtimes.data" u (cx("si-noninduced-hybrid-preprocess-gac-comm-propagate-20201208",1000)):(cy("si-noninduced-hybrid-preprocess-gac-comm-propagate-20201208",1000)) smooth cum w l ls 6 ti '\raisebox{-2.0mm}{Propagating}' at end, \
    "../paper/runtimes.data" u (cx("si-noninduced-hybrid-preprocess-gac-comm-rollback-20201208",1000)):(cy("si-noninduced-hybrid-preprocess-gac-comm-rollback-20201208",1000)) smooth cum w l ls 8 ti '\raisebox{-1.7mm}{~~~Rollback}' at end, \
