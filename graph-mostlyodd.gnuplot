...
plot \
    "runtimes.data" u (cx("minion-mostlyodd",1000)):(cy("minion-mostlyodd",1000)) smooth cum w l lw 2 ti "Minion" at end, \
    "runtimes.data" u (cx("hybrid-mostlyodd",1000)):(cy("hybrid-mostlyodd",1000)) smooth cum w l lw 2 ti "Checking" at end, \
    "runtimes.data" u (cx("hybrid-mostlyodd-always",1000)):(cy("hybrid-mostlyodd-always",1000)) smooth cum w l lw 2 ti '\raisebox{-1mm}{Propagating}' at end, \
    "runtimes.data" u (cx("hybrid-mostlyodd-never",1000)):(cy("hybrid-mostlyodd-never",1000)) smooth cum w l lw 2 ti "Testing" at end, \
    "runtimes.data" u (cx("hybrid-mostlyodd-rbj",1000)):(cy("hybrid-mostlyodd-rbj",1000)) smooth cum w l lw 2 ti '\raisebox{1mm}{Rollback}' at end
