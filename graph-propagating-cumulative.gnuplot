...
plot \
    ...
    "runtimes.data" u (cx("hybrid-checking",1000)):(cy("hybrid-checking",1000)) smooth cum w l lw 2 dt ".", \
    "runtimes.data" u (cx("hybrid-always",1000)):(cy("hybrid-always",1000)) smooth cum w l lw 2 lc 4 ti 'Propagating' at end, \
    "runtimes.data" u (cx("hybrid-never",1000)):(cy("hybrid-never",1000)) smooth cum w l lw 2 lc 5 ti '\raisebox{2mm}{Testing}' at end
